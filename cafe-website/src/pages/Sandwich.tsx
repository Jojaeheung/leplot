...
const posterImages = [
  ...
  },
  {
    ...
    description: '바삭한 베이컨과 신선한 계란'
  },
  {
    id: 3,
    title: '신선한 야채 샌드위치',
    image: 'https://images.unsplash.com/photo-1571091718767-18b5b1457add?w=800&h=400&fit=crop',
    description: '직접 담근 피클과 신선한 야채'
  },
  {
    id: 4,
    title: '하프 샌드위치 세트',
    image: 'https://images.unsplash.com/photo-1586816001966-79b736744398?w=800&h=400&fit=crop',
    description: '하프 샌드위치 + 음료 + 디저트'
  }
];
    ...
    <div className="space-y-8">
      ...
      {filteredItems.length === 0 && (
        <div className="text-center py-16">
          ...
          <h3 className="text-xl font-semibold text-gray-500 mb-2">해당 가격대의 샌드위치가 없습니다</h3>
